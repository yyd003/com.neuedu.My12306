...
<script type="text/javascript">
	...
	/Admin/admin?action=list";
			...
			req.send("realname=" + realname + "&sex=" + sex + "&certType="
					+ certType + "&cert=" + cert + "&userType=" + userType
					+ "&pageSize=" + pageSize + "&source=0&page=" + page);
		}
	}
	...
	function updatePage() {
		...
		if (req.readyState == 4) {
			if (req.status == 200) {
				...
				// 显示页数
				var pageCount = parseInt(xmlDoc
						.getElementsByTagName('pageCount')[0].firstChild.nodeValue);
				var p = "";
				for (var i = 1; i <= pageCount; i++) {
					p += '<a href="javascript:processRequest(' + i + ');">' + i
							+ '</a> ';
				}
				...
				for (var i = 0; i < user.length; i++) {
					...
					c += '<td width="98" bordercolor="#FFFFFF"  class="text_cray1">'
							+ realname + '</td>';
					c += '<td width="80" bordercolor="#FFFFFF"  class="text_cray1">'
							+ sex + '</td>';
					c += '<td width="132" bordercolor="#FFFFFF"  class="text_cray1">'
							+ certType + '</td>';
					c += '<td width="247" bordercolor="#FFFFFF"  class="text_cray1">'
							+ cert + '</td>';
					c += '<td width="82" bordercolor="#FFFFFF"  class="text_cray1">'
							+ userType + '</td>';
					c += '<td width=\"89\" bordercolor=\"#FFFFFF\"  class=\"text_cray1\"><a href=\"javascript:alert(\'请学员参考查询实现！\')\" class=\"text_red\">编辑</a></td>';
					c += "</tr>";
				}
				c += "<table>";
				td.innerHTML = c;
	...
	<form name="form1" method="post" action="#">
		...
		<table width="850" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td width="822" align="left" valign="top" class="text_blod_title">用户管理</td>${data.users}
			</tr>
			<tr>
				...
				<td width="835" background="../images/wb_01 (3).jpg"><table
						...
						<tr>
							...
							<td width="11%" align="left" class="text_cray1"><label>
									...
									class="text_cray" style="width: 80px"
									value="${sessionScope.listUser.realname }">
							</label></td>
							...
							<td width="13%" align="left" class="text_cray1"><label>
									<input name="cert" id="cert" type="text" class="text_cray"
							...
							<td width="8%" align="center" valign="middle"
								class="text_craybold"><label> <input name="button"
									type="button" class="butcx" value=""
									onclick="processRequest(1)" />
							</label></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
					...
					<table id="content" width="553" border="1" align="center"
						cellpadding="0" cellspacing="1" bordercolor="#dadada"
						bgcolor="#FFFFFF">
						<tr align="center">
						...
						<c:forEach items="${data.users}" var="s" varStatus="s1">
							<tr align="center">
								<td width="44" height="25" valign="middle" bordercolor="#FFFFFF"
									bgcolor="#FFFFFF" class="text_cray1">选择</td>
								<td width="98" height="25" valign="middle" bordercolor="#FFFFFF"
									bgcolor="#FFFFFF" class="text_cray1"><c:out
										value="${s.realname}" /></td>
								<td width="80" height="25" valign="middle" bordercolor="#FFFFFF"
									bgcolor="#FFFFFF" class="text_cray1"><c:out
										value="${s.sex}" /></td>
								<td width="132" height="25" valign="middle"
									bordercolor="#FFFFFF" bgcolor="#FFFFFF" class="text_cray1"><c:out
										value="${s.certType.content}" /></td>
								<td width="247" height="25" valign="middle"
									bordercolor="#FFFFFF" bgcolor="#FFFFFF" class="text_cray1"><c:out
										value="${s.cert}" /></td>
								<td width="82" height="25" valign="middle" bordercolor="#FFFFFF"
									bgcolor="#FFFFFF" class="text_cray1"><c:out
										value="${s.userType.content}" /></td>
								<td width="89" height="25" valign="middle" bordercolor="#FFFFFF"
									bgcolor="#FFFFFF" class="text_cray1">操作</td>
							</tr>
						</c:forEach>
						...
						<tr align="center">
							<td id="container" colspan="7" bordercolor="#FFFFFF"
						...
						<tr align="center">
							<td width="102" align="left" class="text_cray1"><a href="#">
									<label></label> <label></label> <label> <input
										...
										onclick="selectAllNullorReserve('ids','反选');"><span
